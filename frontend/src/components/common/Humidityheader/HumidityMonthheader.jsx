...
// api 주소
const SERVER_URL = "/Get_AHU_hum_monthly_Data";
...
// 시간별 온도 차트
const HumidityMonthheader = () => {
  // 시간별 전력량 공조기 ID와 날짜 (삭제 예정)
  const [startDate, setStartDate] = useState({});
  const { setMHumiDt } = useStateContext();
...
export default HumidityMonthheader;
